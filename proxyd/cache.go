...
func newRedisCache(redisClient *redis.Client, redisReadClient *redis.Client, prefix string, defaultTTL time.Duration, shortLivedTTL time.Duration) *redisCache {
